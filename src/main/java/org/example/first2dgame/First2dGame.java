...
public class First2dGame extends GameApplication {
    ...
    protected void initPhysics() {
        onCollisionBegin(GameFactory.EntityType.DUKE, GameFactory.EntityType.CENTER, (duke, center) ->
                this.player.getComponent(PlayerComponent.class).die());

        onCollisionBegin(GameFactory.EntityType.DUKE, GameFactory.EntityType.CLOUD, (enemy, cloud) ->
                this.player.getComponent(PlayerComponent.class).die());

        onCollisionBegin(GameFactory.EntityType.BULLET, GameFactory.EntityType.CLOUD, (bullet, cloud) -> {
            inc("score", 1);
